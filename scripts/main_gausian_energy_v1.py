...
def main():
	...
	# Defined variables to learn from.
	variables = ["time", "icmiss", "ichold", "dcmiss", "dchold", "wbhold", "ainst", "iinst", "bpmiss", "ahbutil", "ahbtutil", "branch", "call", "type2", "ldst", "load", "store"]
	...
	for benchmark in benchmarks:
		...
		# Extract dataset
		y = result_df[["Energy[J]"]].values
		X = result_df[variables].values 
	...
	# Step 5: Plot actual vs predicted values
		...
		plt.legend()
		# plt.ylim(0,3.5)
		plt.savefig("Energy Results for "+benchmark+".png")
